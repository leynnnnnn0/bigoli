...
def main():
    ...
    cases = [
        ...
        ("TC-12", "Staff Issue Stamp", "Staff gives stamp code", "Staff opens dashboard; selects loyalty card; enters transaction number and amount spent; clicks Generate Code.", "Unique stamp code and QR code are generated under the staff account and selected branch.", ""),
        ...
        ("TC-14", "Staff Issue Stamp", "Missing transaction number", "Staff attempts to generate a stamp code without entering a transaction number.", "System prevents generation and displays required field validation.", ""),
        ...
        ("TC-23", "Issue Stamp", "Business generates code", "Business opens Issue Stamp; selects loyalty card; enters transaction number and amount spent; clicks Generate Code.", "Unique stamp code and QR code are generated.", ""),
        ("TC-24", "Issue Stamp", "Missing transaction number", "Attempt to generate a stamp code without entering a transaction number.", "System prevents generation and displays required field validation.", ""),
        ("TC-25", "Stamp Codes", "View generated codes", "Business opens Stamp Codes page; search/filter by code, status, branch, card, assignment, and date.", "Generated stamp codes are visible with correct status, branch, card, transaction number, and amount spent.", ""),
