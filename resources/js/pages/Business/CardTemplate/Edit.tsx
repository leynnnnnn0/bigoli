...
export default function Edit({
    ...
    const addPerk = () => {
        setData('perks', [
            ...data.perks,
            { stampNumber: 1, reward: '', color: '#FF6B6B', details: '' },
        ]);
    };
    ...
    return (
        <AppLayout>
            ...
            <Alert variant="destructive">
                <LucideMessageCircleWarning />
                <AlertTitle>
                    Important: This affects existing customers
                </AlertTitle>
                <AlertDescription>
                    Any changes to these perks will immediately update all
                    active customer loyalty cards. Make sure your customers are
                    aware of perk changes before saving.
                </AlertDescription>
            </Alert>
                      ...
                      {errors.logo && <p className="text-xs md:text-sm text-red-500">{errors.logo}</p>}
                                        ...
                                        <div className="space-y-2">
                                            ...
                                            <p className="text-xs text-gray-500">
                                                Upload an image to fill the
                                                stamps when completed. Overrides
                                                stamp colors.
                                            </p>
                                            <div className="flex items-center gap-4">
                                                <Button
                                ...
                                <Card>
                                    <CardHeader>
                                        ...
                                        <CardDescription className="text-xs md:text-sm">
                                            ...
                                            template is available in. Leave
                                            empty to make it available at all
                                            branches.
                                        </CardDescription>
                                    </CardHeader>
                                    <CardContent className="space-y-4">
                    ...
                    <AlertDialogHeader>
                        ...
                        <AlertDialogDescription className="space-y-2">
                            <p className="font-medium text-foreground">
                                This will update the loyalty card template for
                                all existing customers.
                            </p>
                            <ul className="list-inside list-disc space-y-1 text-sm">
                                <li>
                                    All active customer cards will reflect these
                                    changes immediately
                                </li>
                                <li>
                                    Perk configurations will be updated across
                                    all cards
                                </li>
                                <li>
                                    Design changes will apply to all existing
                                    cards
                                </li>
                            </ul>
                            <p className="pt-2 text-sm">
                                Are you sure you want to proceed with these
                                changes?
                            </p>
                        </AlertDialogDescription>
                    </AlertDialogHeader>
