                    ...
                    <div className="relative flex-1">
                        ...
                        <Input
                            ...
                            placeholder={
                                isMobile
                                    ? 'Search stamp codes...'
                                    : 'Search codes, transaction numbers, customers...'
                            }
                            value={search}
                            ...
                            <div className="grid grid-cols-1 gap-4 sm:grid-cols-2">
                                {[
                                    ...
                                    },
                                    {
                                        ...
                                        value:
                                            selectedCode.transaction_number ??
                                            'N/A',
                                    },
                                    {
                                        label: 'Amount Spent',
                                        value: Number(
                                            selectedCode.amount_spent,
